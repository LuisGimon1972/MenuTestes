...
app.post('/executar', (req, res) => {
  ...
  const comandos = {
    ...
    credenciadora: 'npx playwright test tests/cadastros/credenciadora.spec.ts --headed',     
    ...
    buscasvarias: 'npx playwright test tests/buscas/buscasvarias.spec.ts --headed',
    ...
    buscacentrocusto: 'npx playwright test tests/buscas/buscacentrocusto.spec.ts --headed',     
    buscaplanocontas: 'npx playwright test tests/buscas/buscaplanocontas.spec.ts --headed',     
    buscacredenciadora: 'npx playwright test tests/buscas/buscacredenciadora.spec.ts --headed',    
    ...
    exclusaocentrocusto: 'npx playwright test tests/exclusao/exclusaocentrocusto.spec.ts --headed', 
    exclusaoplanoconta: 'npx playwright test tests/exclusao/exclusaoplanoconta.spec.ts --headed', 
    exclusaocredenciadora: 'npx playwright test tests/exclusao/exclusaocredenciadora.spec.ts --headed',    
