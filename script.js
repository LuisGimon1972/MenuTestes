...
const RELACAO_COMANDO_SECAO = {
  ...
  marcas: "cadastrosbas", centrocusto: "cadastrosbas", planoconta: "cadastrosbas",
  ...
  exclusaomarcas: "exclusoes", buscapessoas: "buscas", buscaprodutos: "buscas", buscausuarios: "buscas",
...
const DICIONARIO_COMANDOS = {
  login: "Autenticação do Sistema", seguranca: "Segurança do Sistema", navegacao: "Navegação do Sistema",  
  empresas: "Cadastro de Empresas", pessoas: "Cadastro de Clientes Não Contribuintes",
  pessoacontribuinte: "Cadastro de Clientes Contribuintes", fornecedor: "Cadastro de Fornecedores", produtos: "Cadastro de Produtos",
  usuarios: "Cadastro de Usuários", perfil: "Cadastro de Perfil de Acesso", funcionarios: "Cadastro de Funcionários",
  pagar: "Cadastro de Pagamento", receber: "Cadastro de Recebimento",
  caixa: "Cadastro do Caixa", bancos: "Cadastro de Bancos", vendas: "Cadastro de Vendas", dav: "Cadastro de DAV",  
  especies: "Cadastro de Espécies", cotacao: "Cadastro de Cotação de moedas", grupos: "Cadastro de Grupos",
  subgrupos: "Cadastro de Subgrupos", marcas: "Cadastro de Marcas", centrocusto: "Cadastro de Centro de custo", planoconta: "Cadastro de Plano de Contas",
  validacaopessoas: "Validação de dados de Pessoas", validacaoprodutos: "Validação de dados de Produtos",
  validacaofuncionarios: "Validação de dados de Funcionários", validacaoespecies: "Validação de dados de Espécies",
  validacaousuarios: "Validação de dados de Usuários", validacaocotacao: "Validação de dados de Cotação de moedas",
  validacaoperfil: "Validação de dados de Perfil de Usuários", validacaogrupos: "Validação de dados de Grupos",
  validacaosubgrupos: "Validação de dados de Subgrupos", validacaomarcas: "Validação de dados de Marcas",
  buscapessoas: "Buscas de Pessoas", buscaprodutos: "Buscas de Produtos", buscausuarios: "Buscas de Usuários",
  buscafaturamento: "Buscas de Faturas", buscadav: "Buscas de DAVs", buscaperfil: "Buscas de Perfil de Acesso",
  buscaespecies: "Buscas de Espécies", buscacotacao: "Buscas de Cotação de Moedas", buscagrupos: "Buscas de Grupos",
  buscasubgrupos: "Buscas de Subgrupos", buscalote: "Buscas de Lotes", buscamarcas: "Buscas de Marcas",
  buscafuncionario: "Buscas de Funcionários", edicaopessoas: "Edição de Dados Pessoas",
  edicaofuncionarios: "Edição de Dados Funcionários", edicaoprodutos: "Edição de Dados Produtos",
  edicaoespecies: "Edição de Dados Espécies", edicaocotacao: "Edição de Dados Cotação de Moedas",
  edicaogrupos: "Edição de Dados Grupos", edicaosubgrupos: "Edição de Dados Subgrupos",
  edicaomarcas: "Edição de Dados Marcas", finalizarvenda: "Finalizar fatura de venda",
  compra: "Finalizar fatura de Compras", exclusaopessoas: "Exclusão de Dados Pessoas",
  exclusaoprodutos: "Exclusão de Dados Produtos", exclusaofuncionarios: "Exclusão de Dados Funcionários",
  exclusaousuarios: "Exclusão de Dados Usuários", exclusaoperfil: "Exclusão de Dados Perfil de Acesso",
  exclusaoespecies: "Exclusão de Dados Espécies", exclusaocotacao: "Exclusão de Dados Cotação de moedas",
  exclusaogrupos: "Exclusão de Dados Grupos", exclusaosubgrupos: "Exclusão de Dados Subgrupos",
  exclusaomarcas: "Exclusão de Dados Marcas", desempenhologin: "Desempenho de Login",
  cadastropessoas: "Desempenho de Cadastro Pessoas", cadastroprodutos: "Desempenho de Cadastro Produtos",
  cadastrofuncionarios: "Desempenho de Cadastro Funcionários", cadastrousuarios: "Desempenho de Cadastro Usuários",
  cadastroespecies: "Desempenho de Cadastro Espécies", desbuscapessoas: "Desempenho de Buscas Pessoas",
  desbuscaprodutos: "Desempenho de Buscas Produtos", desbuscafuncionarios: "Desempenho de Buscas Funcionários",
  desbuscausuarios: "Desempenho de Buscas Usuários", desbuscaespecies: "Desempenho de Buscas Espécies",
  navegacaomobile: "Responsividade Navegação Mobile", navegacaotablet: "Responsividade Navegação Tablet",
  pessoa_fatura: "Integração Cliente e Faturamento", pessoa_dav: "Integração Cliente e DAV",
  funcionario_fatura: "Integração Funcionário e Faturamento", funcionario_dav: "Integração Funcionário e DAV",
  produto_fatura: "Integração Produto e Faturamento", produto_dav: "Integração Produto e DAV",
  fornecedor_produto: "Integração Fornecedor e Produto", usuario_funcionario: "Integração Usuário e Funcionário",
  perfil_usuario: "Integração Perfil de Acesso e Usuários", todos: "Execução completa dos testes"
};
...
const COMANDOS_EXECUCAO_TOTAL = [
  ...
  'especies', 'cotacao', 'grupos', 'subgrupos', 'marcas', 'centrocusto', 'planoconta',
  ...
  'exclusaosubgrupos', 'exclusaomarcas', 'validacaopessoas', 'validacaousuarios', 'exclusaoperfil', 'validacaoperfil', 'validacaofuncionarios', 
