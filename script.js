...
const RELACAO_COMANDO_SECAO = {
  ...
  finalizarvenda: "finalizacao", compra: "finalizacao", finalizardav: "finalizacao", importardav: "finalizacao", exclusaopessoas: "exclusoes", 
  ...
  buscasvarias: "buscas", buscapessoas: "buscas", buscaprodutos: "buscas", buscausuarios: "buscas",
  ...
  buscamarcas: "buscas", buscafuncionario: "buscas", buscacentrocusto:"buscas", buscaplanocontas: "buscas", buscacredenciadora: "buscas",
  desempenhologin: "desempenho", cadastropessoas: "desempenho", cadastroprodutos: "desempenho", cadastrofuncionarios: "desempenho", 
...
const DICIONARIO_COMANDOS = {
  ...
  buscacentrocusto: "Buscas de Centros de Custos",
  buscaplanocontas: "Buscas de Planos de Conta",
  buscacredenciadora : "Buscas de Credenciadoras/taxas",
  ...
  finalizardav: "Finalizar DAV",
  importardav: "Importar e faturar DAV",
...
const COMANDOS_EXECUCAO_TOTAL = [
  ...
  'edicaogrupos', 'edicaosubgrupos', 'edicaomarcas', 'finalizarvenda', 'finalizardav', 'importardav',  'compra', ': "buscasvarias", ', 'buscapessoas', 'buscaprodutos', 'buscafaturamento', 
  ...
  'buscacentrocusto', 'buscaplanocontas', 'buscacredenciadora',
